...
We conclude, that we have to reject on of the hypotheses: Either the output of the inverse function (of this special one-way function) is really truly random and exhibits no patterns or the algorithms we tested were not able to learn these potential patterns.
